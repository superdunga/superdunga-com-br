...
$atalhos = [
    [
        ...
        'botao' => 'btn-success',
        'icone' => '$',
        'visivel' => grupoPermitido($pdo_master, $empresaId, 'Tesouraria', $nivelUsuario),
    ],
    [
        ...
        'botao' => 'btn-warning',
        'icone' => 'FC',
        'visivel' => grupoPermitido($pdo_master, $empresaId, 'Fechamento', $nivelUsuario),
    ],
    [
    ...
    [
        ...
        'botao' => 'btn-dark',
        'icone' => 'Sync',
        'visivel' => moduloPermitido($pdo_master, $empresaId, 'sincronizacao', $nivelUsuario),
    ],
    [
        'titulo' => 'WhatsApp Gerencial',
        'descricao' => 'Configure destinatarios e rotinas gerenciais compartilhadas.',
        'href' => 'modulos/whatsapp/index.php',
        'classe' => 'border-success',
        'botao' => 'btn-success',
        'icone' => 'WA',
        'visivel' => $nivelUsuario === 'MASTER' && moduloPermitido($pdo_master, $empresaId, 'whatsapp', $nivelUsuario),
    ],
    [
        'titulo' => 'WhatsApp Operacional',
        'descricao' => 'Atendimento e comunicacoes operacionais da empresa.',
        'href' => 'modulos/whatsapp_operacional/index.php',
        'classe' => 'border-success',
        'botao' => 'btn-success',
        'icone' => 'WO',
        'visivel' => $nivelUsuario === 'MASTER' && moduloPermitido($pdo_master, $empresaId, 'whatsapp_operacional', $nivelUsuario),
    ],
    [
        ...
        'botao' => 'btn-primary',
        'icone' => 'U',
        'visivel' => ($nivelUsuario === 'MASTER' || $nivelUsuario === 'ADMIN') && moduloPermitido($pdo_master, $empresaId, 'usuarios', $nivelUsuario),
    ],
    [
        ...
        'botao' => 'btn-secondary',
        'icone' => 'E',
        'visivel' => $nivelUsuario === 'MASTER' && moduloPermitido($pdo_master, $empresaId, 'empresas', $nivelUsuario),
    ],
];
