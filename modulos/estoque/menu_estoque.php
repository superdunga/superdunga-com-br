    ...
    <div class="p-4 p-lg-5 bg-white border rounded-2 shadow-sm">
        <div class="row align-items-center g-3">
            <div class="col-lg-8">
                ...
                <h1 class="h3 fw-bold mb-2">Estoque</h1>
                <p class="text-muted mb-0">Central para acompanhar saldos, movimentos e valor do estoque.</p>
            </div>
...
<section>
    <div class="row g-3">
        ...
        <?php if (empty($opcoes)): ?>
            <div class="col-12">
                <div class="alert alert-info mb-0">Nenhum modulo de estoque liberado para esta empresa.</div>
            </div>
        <?php endif; ?>
    </div>
</section>
