...
$opcoes = [
    [
        ...
        'descricao' => 'Registre documentos, leia codigos dos produtos e finalize com selfie do responsavel.',
        'href' => 'recebimento_mercadorias.php',
        'modulo' => 'recebimento_mercadorias',
        'icone' => 'RM',
        'botao' => 'btn-success',
    ],
    [
    ...
    <div class="p-4 p-lg-5 bg-white border rounded-2 shadow-sm">
        <div class="row align-items-center g-3">
            <div class="col-lg-8">
                ...
                <h1 class="h3 fw-bold mb-2">Rotinas Operacionais</h1>
                <p class="text-muted mb-0">Rotinas simples para execucao no piso da loja, com foco em celular.</p>
            </div>
...
<section>
    <div class="row g-3">
        ...
        <?php if (empty($opcoes)): ?>
            <div class="col-12">
                <div class="alert alert-info mb-0">Nenhuma rotina operacional liberada para esta empresa.</div>
            </div>
        <?php endif; ?>
    </div>
</section>
