...
$opcoes = [
    [
        'titulo' => 'DRE',
        'descricao' => 'Demonstrativo de resultado para acompanhar receitas, custos, despesas e saldo operacional.',
        'href' => 'dre.php',
        'modulo' => 'gestao_dre',
        'icone' => 'DR',
        'botao' => 'btn-primary',
    ...
    <div class="p-4 p-lg-5 bg-white border rounded-2 shadow-sm">
        <div class="row align-items-center g-3">
            <div class="col-lg-8">
                ...
                <h1 class="h3 fw-bold mb-2">Gestão</h1>
                <p class="text-muted mb-0">Central para rotinas gerenciais e acompanhamentos do sistema.</p>
            </div>
...
<section>
    <div class="row g-3">
        ...
        <?php if (empty($opcoes)): ?>
            <div class="col-12">
                <div class="alert alert-info mb-0">Nenhuma rotina de gestão configurada para esta empresa.</div>
            </div>
        <?php endif; ?>
    </div>
</section>
