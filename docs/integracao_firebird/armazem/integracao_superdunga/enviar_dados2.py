...
def processar_tabela(nome, url_api, tabela_php):
    try:
        ...
        print(f"Última REGSTAMP: {ultima_regstamp}")
        ...
        if len(dados) > 0:
            ...
            # 🔹 ALTERAÇÃO CIRÚRGICA: somente EST007 vai em lotes
...
print("🚀 INICIANDO ENVIO FIREBIRD → MYSQL")
...
try:
    ...
    # 🔥 DETECÇÃO DE DELETADOS (OTIMIZADA)
    ...
    # 🔹 NOVO BLOCO ZCONFIG005 (CIRÚRGICO)
    processar_tabela(
        "ZCONFIG005",
