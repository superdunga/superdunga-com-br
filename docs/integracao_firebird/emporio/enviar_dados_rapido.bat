...
echo Iniciando sincronizacao rapida EMPORIO...
echo Data/hora: %date% %time%

python enviar_dados.py rapido >> C:\Integracao_Emporio\logs\sincronizacao_rapida.log 2>&1

echo Atualizando embalagens Firebird... >> C:\Integracao_Emporio\logs\sincronizacao_rapida.log 2>&1
...
echo Atualizando produtos/compras Firebird... >> C:\Integracao_Emporio\logs\sincronizacao_rapida.log 2>&1
