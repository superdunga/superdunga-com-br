...
function sistemaModulosPadrao(): array
{
    return [
        ...
        ['codigo' => 'desconto_cheques', 'grupo' => 'Desconto de Cheques', 'nome' => 'Desconto de Cheques', 'url' => 'modulos/desconto_cheques/menu_desconto_cheques.php', 'ordem' => 319, 'somente_master' => true],
        ['codigo' => 'desconto_cheques_clientes', 'grupo' => 'Desconto de Cheques', 'nome' => 'Clientes', 'url' => 'modulos/desconto_cheques/clientes.php', 'ordem' => 320, 'somente_master' => true],
        ['codigo' => 'desconto_cheques_operacoes', 'grupo' => 'Desconto de Cheques', 'nome' => 'Operacoes', 'url' => 'modulos/desconto_cheques/operacoes.php', 'ordem' => 321, 'somente_master' => true],
        ['codigo' => 'desconto_cheques_feriados', 'grupo' => 'Desconto de Cheques', 'nome' => 'Feriados', 'url' => 'modulos/desconto_cheques/feriados.php', 'ordem' => 322, 'somente_master' => true],

        ['codigo' => 'movimentacao_baixa', 'grupo' => 'Movimentacao/Baixa', 'nome' => 'Movimentacao/Baixa', 'url' => 'modulos/movimentacao_baixa/menu_movimentacao_baixa.php', 'ordem' => 323, 'somente_master' => true],
        ['codigo' => 'movimentacao_baixa_caixa_banco', 'grupo' => 'Movimentacao/Baixa', 'nome' => 'Caixa/Banco', 'url' => 'modulos/movimentacao_baixa/caixa_banco.php', 'ordem' => 324, 'somente_master' => true],
        ['codigo' => 'movimentacao_baixa_contas_pagar', 'grupo' => 'Movimentacao/Baixa', 'nome' => 'Contas a Pagar', 'url' => 'modulos/movimentacao_baixa/contas_pagar.php', 'ordem' => 325, 'somente_master' => true],
        ['codigo' => 'movimentacao_baixa_contas_receber', 'grupo' => 'Movimentacao/Baixa', 'nome' => 'Contas a Receber', 'url' => 'modulos/movimentacao_baixa/contas_receber.php', 'ordem' => 326, 'somente_master' => true],
        ['codigo' => 'movimentacao_baixa_clientes', 'grupo' => 'Movimentacao/Baixa', 'nome' => 'Clientes', 'url' => 'modulos/movimentacao_baixa/clientes.php', 'ordem' => 327, 'somente_master' => true],
        ['codigo' => 'movimentacao_baixa_fornecedores', 'grupo' => 'Movimentacao/Baixa', 'nome' => 'Fornecedores', 'url' => 'modulos/movimentacao_baixa/fornecedores.php', 'ordem' => 328, 'somente_master' => true],
