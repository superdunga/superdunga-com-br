...
function sistemaModulosPadrao(): array
{
    return [
        ...
        ['codigo' => 'colaboradores_vales_diarios', 'grupo' => 'Colaboradores', 'nome' => 'Vales Diarios', 'url' => 'modulos/colaboradores/vales_diarios.php', 'ordem' => 315],

        ['codigo' => 'unimed', 'grupo' => 'Unimed', 'nome' => 'Unimed', 'url' => 'modulos/unimed/menu_unimed.php', 'ordem' => 316, 'somente_master' => true],
        ['codigo' => 'unimed_cadastro', 'grupo' => 'Unimed', 'nome' => 'Cadastro de Usuarios', 'url' => 'modulos/unimed/cadastro.php', 'ordem' => 317, 'somente_master' => true],
        ['codigo' => 'unimed_faturas', 'grupo' => 'Unimed', 'nome' => 'Faturas Mensais', 'url' => 'modulos/unimed/faturas.php', 'ordem' => 318, 'somente_master' => true],

        ['codigo' => 'energia', 'grupo' => 'Energia', 'nome' => 'Energia', 'url' => 'modulos/energia/menu_energia.php', 'ordem' => 319, 'somente_master' => true],
        ['codigo' => 'energia_contas', 'grupo' => 'Energia', 'nome' => 'Contas de Energia', 'url' => 'modulos/energia/contas.php', 'ordem' => 320, 'somente_master' => true],
        ['codigo' => 'energia_operacoes', 'grupo' => 'Energia', 'nome' => 'Operacoes', 'url' => 'modulos/energia/operacoes.php', 'ordem' => 321, 'somente_master' => true],

        ['codigo' => 'desconto_cheques', 'grupo' => 'Desconto de Cheques', 'nome' => 'Desconto de Cheques', 'url' => 'modulos/desconto_cheques/menu_desconto_cheques.php', 'ordem' => 322, 'somente_master' => true],
        ...
        ['codigo' => 'movimentacao_baixa', 'grupo' => 'Movimentacao/Baixa', 'nome' => 'Movimentacao/Baixa', 'url' => 'modulos/movimentacao_baixa/menu_movimentacao_baixa.php', 'ordem' => 326, 'somente_master' => true],
        ['codigo' => 'movimentacao_baixa_caixa_banco', 'grupo' => 'Movimentacao/Baixa', 'nome' => 'Caixa/Banco', 'url' => 'modulos/movimentacao_baixa/caixa_banco.php', 'ordem' => 327, 'somente_master' => true],
        ['codigo' => 'movimentacao_baixa_contas_pagar', 'grupo' => 'Movimentacao/Baixa', 'nome' => 'Contas a Pagar', 'url' => 'modulos/movimentacao_baixa/contas_pagar.php', 'ordem' => 328, 'somente_master' => true],
        ['codigo' => 'movimentacao_baixa_contas_receber', 'grupo' => 'Movimentacao/Baixa', 'nome' => 'Contas a Receber', 'url' => 'modulos/movimentacao_baixa/contas_receber.php', 'ordem' => 329, 'somente_master' => true],
        ['codigo' => 'movimentacao_baixa_clientes', 'grupo' => 'Movimentacao/Baixa', 'nome' => 'Clientes', 'url' => 'modulos/movimentacao_baixa/clientes.php', 'ordem' => 330, 'somente_master' => true],
        ['codigo' => 'movimentacao_baixa_fornecedores', 'grupo' => 'Movimentacao/Baixa', 'nome' => 'Fornecedores', 'url' => 'modulos/movimentacao_baixa/fornecedores.php', 'ordem' => 331, 'somente_master' => true],
        ['codigo' => 'movimentacao_baixa_contas_bnc', 'grupo' => 'Movimentacao/Baixa', 'nome' => 'Contas BNC002', 'url' => 'modulos/movimentacao_baixa/contas_bnc.php', 'ordem' => 332, 'somente_master' => true],
        ['codigo' => 'movimentacao_baixa_tipoes', 'grupo' => 'Movimentacao/Baixa', 'nome' => 'TipoES', 'url' => 'modulos/movimentacao_baixa/tipoes.php', 'ordem' => 333, 'somente_master' => true],
        ['codigo' => 'movimentacao_baixa_recorrencias', 'grupo' => 'Movimentacao/Baixa', 'nome' => 'Recorrencias', 'url' => 'modulos/movimentacao_baixa/recorrencias.php', 'ordem' => 334, 'somente_master' => true],
        ['codigo' => 'movimentacao_baixa_investimentos', 'grupo' => 'Movimentacao/Baixa', 'nome' => 'Investimentos', 'url' => 'modulos/movimentacao_baixa/investimentos.php', 'ordem' => 335, 'somente_master' => true],
